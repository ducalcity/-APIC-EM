...
def mytrace():
    ...
    api_url = "https://devnetsbx-netacad-apicem-3.cisco.com/api/v1/flow-analysis"  # URL of API endpoint
    ...
    while True:
        ...
        # IP address"
        s_ip = input("Introduzca la IP origen: ") # Request user input for source host IP address, e.g. "Please enter the source host IP address"
        d_ip = input("Introduzca la IP destino: ")  # Request user input for destination host IP address, e.g. "Please enter the destination host IP address"
        #++++++++++++++++++++++++++++++++++++
